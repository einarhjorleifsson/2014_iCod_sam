...
```
This occurs quite late in the function code within the *SAM2FLR*-function when reading the mortality output matrix. What is done here is to split the *FLSAM* function into two pieces. Lets source them:
```{r}
